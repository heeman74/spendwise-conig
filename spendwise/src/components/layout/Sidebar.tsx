...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 z-30 h-full w-64 bg-white border-r border-gray-200 dark:bg-gray-900 dark:border-gray-800 transition-transform duration-300 lg:translate-x-0',
      ...
      >
        ...
        <div className="flex items-center gap-2 px-6 py-5 border-b border-gray-200 dark:border-gray-800">
          ...
          <span className="text-xl font-bold text-gray-900 dark:text-white">SpendWise</span>
        </div>
